...
{
public:
	Mu100Osd(osd_options &options, AudioCapture &cap)
		: osd_common_t(options), m_cap(cap) {}
...
// ----------------------------------------------------------------------------
// main: awm2_host <out.wav> -- <mame args...>
...
int main(int argc, char **argv)
{
	...
	if (!out_wav || mame_args.size() <= 1) {
		fprintf(stderr,
			"usage: %s <out.wav> -- mu100 -rompath <dir> -video none -sound none \\\n"
